...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    playRingColor: '#666', // how much has played
  ...
  this.handleClick = function(e) {
    ...
    if (thisSound) {
      ...
      thisSound._360data = {
        ...
        showHMSTime: has_vis,
        amplifier: 1, // TODO: x1 if not being used, else use dynamic "how much to amplify by" value
        ...
        oAnimProgress: function(nProgress) {
          ...
          if (thisSound._360data.scaleFont && thisSound._360data.fontSizeMax !== null) {
            ...
            thisSound._360data.oTiming.style.opacity = 1;
          }
